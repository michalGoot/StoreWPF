...
namespace Store {
    ...
    public partial class OrderDs : global::System.Data.DataSet {
        ...
        public partial class OrderDataTable : global::System.Data.TypedTableBase<OrderRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public OrderRow AddOrderRow(int CustomerId, System.DateTime Date, int Amount) {
...
namespace Store.OrderDsTableAdapters {
    ...
    public partial class OrderTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Order] WHERE (([Id] = @Original_Id) AND ((@IsNull_CustomerId = 1 AND [CustomerId] IS NULL) OR ([CustomerId] = @Original_CustomerId)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ((@IsNull_Amount = 1 AND [Amount] IS NULL) OR ([Amount] = @Original_Amount)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Order] ([CustomerId], [Date], [Amount]) VALUES (@CustomerId, @" +
                "Date, @Amount);\r\nSELECT Id, CustomerId, Date, Amount FROM [Order] WHERE (Id = SC" +
                "OPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Order] SET [CustomerId] = @CustomerId, [Date] = @Date, [Amount] = @Amount WHERE (([Id] = @Original_Id) AND ((@IsNull_CustomerId = 1 AND [CustomerId] IS NULL) OR ([CustomerId] = @Original_CustomerId)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ((@IsNull_Amount = 1 AND [Amount] IS NULL) OR ([Amount] = @Original_Amount)));
SELECT Id, CustomerId, Date, Amount FROM [Order] WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, CustomerId, Date, Amount FROM dbo.[Order]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "dbo.createOrderForCustomer";
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@productAmount", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 10, 0, null, global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@orderId", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.InputOutput, 10, 0, null, global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "dbo.deleteOrderById";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.StoredProcedure;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@RETURN_VALUE", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.ReturnValue, 10, 0, null, global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@paramId", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 10, 0, null, global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "dbo.selectOrderByCustomerId";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.StoredProcedure;
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@RETURN_VALUE", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.ReturnValue, 10, 0, null, global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ParameterCustomerId", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 10, 0, null, global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(OrderDs.OrderDataTable dataTable) {
        ...
        public virtual OrderDs.OrderDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            OrderDs.OrderDataTable dataTable = new OrderDs.OrderDataTable();
        ...
        public virtual OrderDs.OrderDataTable selectOrderByCustomerId(global::System.Nullable<int> ParameterCustomerId) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if ((ParameterCustomerId.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[1].Value = ((int)(ParameterCustomerId.Value));
            }
            else {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(OrderDs.OrderDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(OrderDs dataSet) {
        ...
        public virtual int Delete(int Original_Id, global::System.Nullable<int> Original_CustomerId, global::System.Nullable<global::System.DateTime> Original_Date, global::System.Nullable<int> Original_Amount) {
        ...
        public virtual int Insert(global::System.Nullable<int> CustomerId, global::System.Nullable<global::System.DateTime> Date, global::System.Nullable<int> Amount) {
        ...
        public virtual int Update(global::System.Nullable<int> CustomerId, global::System.Nullable<global::System.DateTime> Date, global::System.Nullable<int> Amount, int Original_Id, global::System.Nullable<int> Original_CustomerId, global::System.Nullable<global::System.DateTime> Original_Date, global::System.Nullable<int> Original_Amount, int Id) {
            if ((CustomerId.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> CustomerId, global::System.Nullable<global::System.DateTime> Date, global::System.Nullable<int> Amount, int Original_Id, global::System.Nullable<int> Original_CustomerId, global::System.Nullable<global::System.DateTime> Original_Date, global::System.Nullable<int> Original_Amount) {
            return this.Update(CustomerId, Date, Amount, Original_Id, Original_CustomerId, Original_Date, Original_Amount, Original_Id);
        }
        
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual object createOrderForCustomer(global::System.Nullable<int> customerId, global::System.Nullable<global::System.DateTime> date, global::System.Nullable<int> productAmount, ref global::System.Nullable<int> orderId) {
            ...
            if ((productAmount.HasValue == true)) {
                command.Parameters[3].Value = ((int)(productAmount.Value));
            }
            else {
            ...
            if (((command.Parameters[4].Value == null) 
                ...
                orderId = new global::System.Nullable<int>(((int)(command.Parameters[4].Value)));
            }
            if (((returnValue == null) 
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int deleteOrderById(global::System.Nullable<int> paramId) {
